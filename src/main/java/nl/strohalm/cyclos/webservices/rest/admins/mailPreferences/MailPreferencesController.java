...
//	}
	...
	public static class MailPreferencesResponse extends GenericResponse{
	...
	@ResponseBody
	protected MailPreferencesResponse formAction(@PathVariable ("systemInvoices") boolean systemInvoices, PreferenceService notificationPreference) throws Exception {
		MailPreferencesResponse response =null;
                try{
		...
		response = new MailPreferencesResponse();
