...
public class EditAdController extends BaseRestController{
	...
	public final void setWriteDataBinder(DataBinder<Ad> writeDataBinder) {
    ...
    *//**
    ...
    public static class EditAdRequestDTO{
    	 private long              id;
    ...
    public static class EditAdResponseDTO{
    	String message;
    	private boolean maxAds;
    	List<Currency> currencies;
    	public EditAdResponseDTO(List<Currency> currencies) {
			super();
		...
		public final boolean isMaxAds() {
			return maxAds;
		}
		public final void setMaxAds(boolean maxAds) {
			this.maxAds = maxAds;
		}
		...
		public final void setAdCount(int adCount) {
			this.adCount = adCount;
		}
		public final int getMaxAdsPerMember() {
			return maxAdsPerMember;
		}
		public final void setMaxAdsPerMember(int maxAdsPerMember) {
    ...
    @ResponseBody
    protected EditAdResponseDTO handleDisplay(@RequestBody EditAdRequestDTO form) throws Exception {
