...
//    }
//
//    @RequestMapping(value = "member/editAdvertisements", method = RequestMethod.GET)
//    @ResponseBody
//    public EditAdsResponse handleDisplay() throws Exception {
//        EditAdsResponse response = new EditAdsResponse();
//        // final AdForm form = context.getForm();
//        // final ActionForward forward = super.handleDisplay(context);
//        final Ad ad = (Ad) response.getAttribute("ad");
//
...
//
//    // @Override
//    protected Ad resolveAd() throws Exception {
//        // final AdForm form = context.getForm();
//        if (LoggedUser.user().getId() > 0L) {
...
//    public Ad readAd() {
//
//        final Ad ad = getWriteDataBinder().readFromString(readAd());
//        if (ad.isHtml()) {
