...
public class AddContactController extends BaseRestController {
    ...
    @ResponseBody
    public AddContactResponse addContact(@RequestBody AddContactResponse request) throws Exception {
...
//        }
        ...
        try {
           contactService.save(contact);
            ...
            response.setMessage(messageResolver.message("contact.inserted", "contact"));
